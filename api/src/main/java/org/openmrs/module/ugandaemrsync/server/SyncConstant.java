...
public class SyncConstant {
	...
	public static final String PERSON_ATTRIBUTE_QUERY = "SELECT\n" + "  (SELECT uuid\n" + "   FROM person AS p\n"
	        ...
	        + "   WHERE pattr.person_attribute_type_id = pa.person_attribute_id) AS person_attribute_type,\n"
	        + "  (SELECT uuid\n" + "   FROM users AS u\n"
	...
	public static final String PATIENT_IDENTIFIER_QUERY = "SELECT\n" + "  (SELECT uuid\n" + "   FROM patient AS p\n"
	        + "   WHERE p.patient_id = pa.patient_id)   AS patient,\n" + "  identifier,\n" + "  identifier_type,\n"
	        + "  preferred,\n" + "  (SELECT uuid\n" + "   FROM location AS l\n"
	...
	public static final String VISIT_QUERY = "SELECT\n" + "  (SELECT uuid\n" + "   FROM patient AS p\n"
	        + "   WHERE p.patient_id = v.patient_id)            AS patient,\n" + "  (SELECT uuid\n"
	...
	public static final String ENCOUNTER_QUERY = "SELECT\n" + "  (SELECT uuid\n" + "   FROM encounter_type AS et\n"
	        ...
	        + "   FROM patient AS p\n" + "   WHERE p.patient_id = e.patient_id)             AS patient,\n"
	        + "  (SELECT uuid\n" + "   FROM location AS l\n"
	...
	public static List<String> OBS_COLUMNS = Arrays.asList("person", "concept", "encounter", "`order`", "obs_datetime",
	    "location", "obs_group", "accession_number", "value_group", "value_boolean", "value_coded", "value_coded_name",
	    "value_drug", "value_datetime", "value_numeric", "value_modifier", "value_text", "value_complex", "comments",
	    "creator", "date_created", "voided", "voided_by", "date_voided", "void_reason", "uuid", "facility", "state",
	    "previous_version");
	...
	public static List<String> ENCOUNTER_ROLE_COLUMNS = Arrays.asList("name", "description", "creator", "date_created",
	    "changed_by", "date_changed", "retired", "retired_by", "date_retired", "retire_reason", "uuid", "facility", "state");
}
